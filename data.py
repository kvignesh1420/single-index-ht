...
class TeacherDataset(Dataset):
    ...
    def load_state(self):
        ...
        self.X = torch.load(os.path.join(self.context["data_dir"], "X_{}.pt".format(self.type)))
        self.y = torch.load(os.path.join(self.context["data_dir"], "y_{}.pt".format(self.type)))
        print("Load sucessful.")
        return True

    def save_state(self):
        print("saving {} X, y to {}".format(self.type, self.context["data_dir"]))
        torch.save(self.X,  os.path.join(self.context["data_dir"], "X_{}.pt".format(self.type)))
        torch.save(self.y,  os.path.join(self.context["data_dir"], "y_{}.pt".format(self.type)))
